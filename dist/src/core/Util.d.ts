...
export declare function extend(dest: ObjectReturnType[]): ObjectReturnType[];
...
export declare function setOptions(obj: ObjectReturnType, options: GeoJSONReturnType): GeoJSONReturnType;
...
export declare const requestFn: (Window & typeof globalThis) | (((callback: FrameRequestCallback) => number) & typeof requestAnimationFrame);
export declare const cancelFn: (Window & typeof globalThis) | (((handle: number) => void) & typeof cancelAnimationFrame);
export declare function requestAnimFrame(fn: FunctionReturnType, context: EventReturnType, immediate: boolean): any;
export declare function cancelAnimFrame(id: NumberReturnType): undefined | void;
export {};
